...
namespace CRCMDB_3._0
{
    public partial class ActorForm : Form
    {
        ...
        private void actorsBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            ...
            this.tableAdapterManager.UpdateAll(this.cRCMDB1DataSet);

        }

        private void ActorForm_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'cRCMDB1DataSet.Actors' table. You can move, or remove it, as needed.
            this.actorsTableAdapter.Fill(this.cRCMDB1DataSet.Actors);
