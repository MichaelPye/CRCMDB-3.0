...
namespace CRCMDB_3._0 {
    ...
    public partial class MovieDataSet : global::System.Data.DataSet {
        ...
        public partial class MovieDataTable : global::System.Data.TypedTableBase<MovieRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public MovieRow AddMovieRow(string Title, string Year, string Genre) {
...
namespace CRCMDB_3._0.MovieDataSetTableAdapters {
    ...
    public partial class MovieTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Movie] WHERE (([MovieId] = @Original_MovieId) AND ((@IsNull_Ye" +
                "ar = 1 AND [Year] IS NULL) OR ([Year] = @Original_Year)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Movie] ([Title], [Year], [Genre]) VALUES (@Title, @Year, @Genr" +
                "e);\r\nSELECT MovieId, Title, Year, Genre FROM Movie WHERE (MovieId = SCOPE_IDENTI" +
                "TY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Movie] SET [Title] = @Title, [Year] = @Year, [Genre] = @Genre WHERE (([MovieId] = @Original_MovieId) AND ((@IsNull_Year = 1 AND [Year] IS NULL) OR ([Year] = @Original_Year)));
SELECT MovieId, Title, Year, Genre FROM Movie WHERE (MovieId = @MovieId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRCMDB_3._0.Properties.Settings.Default.CRCMDBConnectionString;
        }
        ...
        public virtual int Fill(MovieDataSet.MovieDataTable dataTable) {
        ...
        public virtual MovieDataSet.MovieDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MovieDataSet.MovieDataTable dataTable = new MovieDataSet.MovieDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MovieDataSet.MovieDataTable dataTable) {
        ...
        public virtual int Delete(int Original_MovieId, string Original_Year) {
        ...
        public virtual int Insert(string Title, string Year, string Genre) {
            if ((Title == null)) {
        ...
        public virtual int Update(string Title, string Year, string Genre, int Original_MovieId, string Original_Year, int MovieId) {
            if ((Title == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(MovieId));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string Year, string Genre, int Original_MovieId, string Original_Year) {
            return this.Update(Title, Year, Genre, Original_MovieId, Original_Year, Original_MovieId);
        }
    }
